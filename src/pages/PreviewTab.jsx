...
const mockSessionData = {
  assistant_commentary: [
    {
      severity: "info",
      commentary: "Session started. ROM base: Emerald (U).",
      timestamp: "00:01",
    },
    {
      severity: "warning",
      commentary:
        "Flag 0x201 (RIVAL_BATTLE_1) checked, but associated script not found on map.",
      timestamp: "02:34",
    },
    {
      severity: "suggestion",
      commentary:
        "Player spent 5 minutes in Rustboro City without triggering any new story events.",
      timestamp: "08:12",
    },
    {
      severity: "error",
      commentary:
        "Script `0x8A01B4` entered an infinite loop after talking to PokéMart NPC.",
      timestamp: "15:45",
    },
  ],
  memory_events: [
    ...
    { address: "0x0202402E", value: "0x0A", description: "Player Y Position" },
    {
      address: "0x02026A58",
      value: "0b10010011",
      description: "Flag Block 0x200-0x207",
    },
  ...
  script_activity: [
    ...
    {
      type: "info",
      message: "ROM loaded: Pokemon Emerald (USA)",
      timestamp: "00:00:02",
    },
    { type: "debug", message: "Flag 0x200 set to TRUE", timestamp: "00:02:15" },
    {
      type: "warning",
      message: "Script timeout detected at 0x8A01B4",
      timestamp: "00:05:30",
    },
    {
      type: "error",
      message: "Memory access violation at 0x02000000",
      timestamp: "00:07:45",
    },
  ],
};
...
function ConsoleTab({ consoleData }) {
  ...
  return (
    <Card className="bg-muted/50 backdrop-blur-sm h-full flex flex-col">
      <CardHeader>
      ...
      <CardContent className="flex-1 overflow-y-auto p-4 font-mono text-xs text-muted-foreground">
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-orange-500 to-amber-500 text-white font-semibold w-28"
                >
                  {isEmulating ? (
                    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="row-start-3 lg:row-start-auto">
            <AssistantCommentary
              comments={sessionData.assistant_commentary}
                ...
                <Card className="bg-muted/50 h-full">
                  ...
                  <CardContent>
                    <p className="text-slate-700 dark:text-slate-300">
                      AI timeline component coming soon.
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
